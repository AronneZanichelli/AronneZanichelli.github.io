...
const translations = {
  en: {
    ...
    'nav.projects': 'Projects', 'nav.editing': 'Editing', 'nav.contact': 'Contact',
    ...
    'work.title': 'Development projects',
    ...
    'graphics.title': 'Graphics & video',
    'graphics.desc': 'A video pipeline that turns one script into six published videos and nine language versions.',
    'graphics.link': 'See all the video work',
    'timeline.title': 'Timeline',
    'timeline.bio': 'I\'m Aronne Zanichelli, a junior software developer working AI-augmented. I write code, but I also write the spec, the plan, and the audit around it — the discipline is the point, not just the output. My path here wasn\'t linear: a technical diploma, a year selling utility contracts, then a creative-and-AI program that put me inside a real production pipeline. Along the way I built five open-source projects I still maintain — none of them portfolio filler; all of them on GitHub, with commits, tests, and the occasional documented mistake — plus a published video pipeline for a real client. I\'m looking for a first developer role, in Italy or abroad, where "I can prove it" counts for more than "I\'m passionate about it."',
    ...
    'skills.s6': 'all five repos: branch-per-feature, documented decisions',
    ...
    'projects.intro': "Five repositories, in the order I'd want a reviewer to open them.",
    ...
    'nf.msg': "This page doesn't exist — or moved. Development projects live under Projects; Labelbike and all video work live under Editing.",
    'nf.cta': 'Back to home'
  },
  it: {
    'a11y.skip': 'Vai al contenuto',
    'nav.projects': 'Progetti', 'nav.editing': 'Editing', 'nav.contact': 'Contatti',
    ...
    'work.title': 'Progetti di sviluppo',
    ...
    'graphics.title': 'Grafica e video',
    'graphics.desc': 'Una pipeline video che trasforma uno script in sei video pubblicati e nove versioni linguistiche.',
    'graphics.link': 'Guarda tutti i lavori video',
    'timeline.title': 'Timeline',
    'timeline.bio': 'Sono Aronne Zanichelli, sviluppatore junior con metodo AI-augmented. Scrivo codice, ma scrivo anche la spec, il piano e l\'audit che lo circondano — la disciplina è il punto, non solo il risultato. Il percorso non è stato lineare: un diploma tecnico, un anno a vendere contratti utility, poi un percorso creative & AI che mi ha messo dentro una pipeline di produzione reale. Nel frattempo ho costruito cinque progetti open source che mantengo tuttora — nessuno è riempitivo da portfolio: sono tutti su GitHub, con commit, test e qualche errore documentato — più una pipeline video pubblicata per un cliente reale. Cerco un primo ruolo da sviluppatore, in Italia o all\'estero, dove "posso dimostrarlo" conti più di "ci metto passione".',
    ...
    'skills.s6': 'tutti e cinque i repository: branch per feature, decisioni documentate',
    ...
    'projects.intro': 'Cinque repository, nell\'ordine in cui vorrei che un revisore le aprisse.',
    ...
    'nf.msg': 'Questa pagina non esiste — o si è spostata. I progetti di sviluppo vivono in Progetti; Labelbike e tutti i lavori video sono in Editing.',
